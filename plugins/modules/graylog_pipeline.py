...
options:
  server:
    description:
      - The Graylog server details to connect to.
      - Can be re-used across multiple calls
    type: dict
  endpoint:
    description:
...
def main():
    ...
    endpoint = module.params['connection']['endpoint']
    graylog_username = module.params['connection']['username']
    graylog_password = module.paramsp['connection']['password']
    ...
    api_token = get_token(module, endpoint, graylog_username, graylog_password)
    headers = '{ "Content-Type": "application/json", "X-Requested-By": "Graylog API", "Accept": "application/json", \
